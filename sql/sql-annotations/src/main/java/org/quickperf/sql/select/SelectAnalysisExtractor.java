...
public class SelectAnalysisExtractor implements ExtractablePerformanceMeasure<SqlExecutions, SelectAnalysis> {
    ...
    public SelectAnalysis extractPerfMeasureFrom(SqlExecutions sqlExecutions) {
        ...
        BooleanMeasure sameSelectTypesWithDiffParamValues = HasSameSelectTypesWithDiffParamsExtractor.INSTANCE.extractPerfMeasureFrom(sqlExecutions);

        return new SelectAnalysis(selectNumber, sameSelectTypesWithDiffParamValues.getValue());

    }

    static class HasSameSelectTypesWithDiffParamsExtractor implements ExtractablePerformanceMeasure<SqlExecutions, BooleanMeasure> {
