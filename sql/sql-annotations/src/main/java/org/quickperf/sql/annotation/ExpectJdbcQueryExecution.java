...
/**
 * <p>The <code>ExpectJdbcQueryExecution</code> annotation verifies the number of JDBC query
 * executions (<i>executeQuery</i>, <i>executeUpdate</i>, <i>execute</i>,
 * <i>executeLargeUpdate</i>, <i>executeBatch</i>, <i>executeLargeBatch</i>). See
 * <a href="http://ttddyy.github.io/datasource-proxy/docs/current/user-guide/index.html">
 * datasource-proxy user guide</a> about JDBC query executions.
...
public @interface ExpectJdbcQueryExecution {
     ...
     * executions (<i>executeQuery</i>, <i>executeUpdate</i>, <i>execute</i>,
     * <i>executeLargeUpdate</i>, <i>executeBatch</i>, <i>executeLargeBatch</i>) is not equal.
